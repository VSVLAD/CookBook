...
description: Довольно бюджетный и красивый вариант блюда для праздничного стола. А
...
steps:
- name: Шаг 1
  description: Для изготовления лодочек понадобится соответствующей формы картофель.
