...
description: Для самый начинающих поваров. Чтобы завтрак был нескучным, можно побаловать
...
steps:
- name: Шаг 1
  description: На сковороде гриль разогреваем растительное масло и кладем кружочки
