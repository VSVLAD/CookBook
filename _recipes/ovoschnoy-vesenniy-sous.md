...
description: Помидорки и кабачки уже созрели, молодая капуста начала появляться на
  рынке, пора готовить овощное рагу в мультиварке. На Кубани называется "соус", это
...
steps:
- name: Шаг 1
  description: Ингредиенты могут быть самыми разнообразными, можно положить зелёную
