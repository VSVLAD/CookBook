...
description: Мой первый цезарь v1 для новогоднего стола. Старался делать аккуратно,
  но с домашним майонезом немного напортачил, благо получился соус в итоге достаточно
  неплохим. Получилось вкусненько, хоть и выполнил не оригинальный рецепт. В наших
...
steps:
- name: Шаг 1
  description: Сухарики обязательно делаем сами, не используйте ржаные или покупные
    с добавками. Белый хлеб нарезаем на кубики и кладём на разогретую на слабом огне
...
- name: Шаг 6
  description: 'Для основы соуса можно использовать готовый майонез или сделать его
    ...
    стакане для блендера и далее вливать тонкой струйкой растительное масло и не прекращать
    взбивать. Пропорции лучше взять из другого рецепта, в моём случае было около 140-180
    мл на 2 яйца. Не всегда удастся сделать майонез с первого раза, если не получилось
    не беда, полученная смесь всё ещё пригодна для салата.'
  images: []
- name: Шаг 7
  description: В майонез, который получился на предыдущем шаге, добавляем чеснок,
    выдавленный через чеснокодавку, горчицу (в моём случае это баварская), тёртый
    сыр пармезан и лимонный сок. Эту смесь взбиваем блендером в однородную массу.
    Пробуем на вкус и делаем под себя. Возможно придётся добавить ещё лимонного сока
    и горчицы.
  images: []
- name: Шаг 8
  description: Перекладываем салат с курицей в соусе в итоговую ёмкость. Добавляем
